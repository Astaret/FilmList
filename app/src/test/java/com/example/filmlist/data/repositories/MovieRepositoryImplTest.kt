...
class MovieRepositoryImplTest {
    ...
    fun `loadData should return list of movies from API`() = runTest {
        val fakeMovies = listOf(Movie(1, "Inception",
            overview = "over1",
            poster = "post1",
            title = "titl1",
            rating = "rat1",
            price = 1f), Movie(2, "Inception2",
            overview = "over2",
            poster = "post1",
            title = "titl1",
            rating = "rat1",
        ...
        whenever(apiService.getTopRatedMovies(language = "ru-Ru", page = 1)).thenReturn(
            TopMovieListDto(fakeMovies.listMovieToListMovieDto(), "1", "2")
        )
    ...
    fun `getMovieByIdFromBd should return movie from DAO`() = runTest {
        val fakeMovie = Movie(1, "Inception",
            overview = "over1",
            poster = "post1",
            title = "titl1",
            rating = "rat1",
    ...
    fun `putMovieToDb should insert movie in DAO`() = runTest {
        ...
        val fakeMovie = Movie(1, "Inception",
            ...
            rating = "rat1",
            price = 1f)
        val movieState = MovieState.ISBOUGHT
